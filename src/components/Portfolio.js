              ...
              <ul>
                <li className="wow fadeInUp" data-wow-duration="1s">
                  <div className="list_inner">
                    <img
                      ...
                      src={userData?.user?.projects[0]?.image?.url}
                    />
                ...
                <li className="wow fadeInUp" data-wow-duration="1s">
                  <div className="list_inner">
                    <img
                      className="background_image"
                      src={userData?.user?.projects[1]?.image?.url}
                    />
                    <div className="content">
                      <div className="details">
                        <span className="category">
                ...
                <li className="wow fadeInUp" data-wow-duration="1s">
                  <div className="list_inner">
                    <img
                      className="background_image" src={userData?.user?.projects[2]?.image?.url}
                    />
                    <div className="content">
                      <div className="details">
                        <span className="category">
                ...
                <li className="wow fadeInUp" data-wow-duration="1s">
                  <div className="list_inner">
                    <img
                      className="background_image"
                      src={userData?.user?.projects[3]?.image?.url}
                    />
                    <div className="content">
                      <div className="details">
                        <span className="category">
